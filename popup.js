...
const FIELD_LABELS = {
  ...
  jobReason: "職種志望理由",
  industryInterest: "業界・事業に興味を持った理由",
  workValues: "働く上で大切にしたいこと",
  challengeExperience: "挑戦した経験",
  failureExperience: "失敗・挫折経験",
  teamworkExperience: "チーム経験",
  leadershipExperience: "リーダーシップ経験",
  achievement: "成果・実績",
  languageSkills: "語学スキル",
  programmingSkills: "IT・プログラミングスキル",
